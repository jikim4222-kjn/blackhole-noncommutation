...
### Black holes
In semiclassical gravity, black holes hide internal structure behind horizons.  
In this framework, they are regions where stabilization preserves distinctions that observation cannot reflect.

### Page curve
If the non‑commuting region grows and later shrinks, any monotone entropy functional reproduces Page‑type behavior.  
...
### Geometry
Geometric horizons are special cases of commutation boundaries.  
The framework applies even when geometry is emergent or unavailable.
